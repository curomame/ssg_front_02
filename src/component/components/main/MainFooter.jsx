    ...
    <div className="footerContents">
            ...
            <p className="footerLight">
              ...
              <Link to='https://www.ftc.go.kr/bizCommPop.do?wrkr_no=8708801143'>사업자 정보확인</Link><br/>개인정보보호 책임자: 김우진<span className="bar">|</span>주소: 서울특별시 강남구 테헤란로 231<br/>호스팅서비스 사업자 : (주)에스에스지닷컴</address>
					...
					<div className="">
						<h3 className="footerBold">SSG.COM 정책 및 약관</h3>
						<ul className="footerBold footerHyperLink">
              ...
              {footerlink ? footerlink.map(link => 
                (
					...
					<div className=" ">
						<p className="footerLight">㈜에스에스지닷컴 사이트의 상품/판매자/쇼핑정보, 컨텐츠, UI 등에 대한 무단 복제, 전송, 배포, 스크래핑 등의 행위는 저작권법, 콘텐츠사업 진흥법 등에 의하여 엄격히 금지됩니다.</p>
					</div>
					<p className="footerLight">Copyright ⓒ SSG.COM Corp. All rights reserved.</p>
				</div>
    </>
  )
}
